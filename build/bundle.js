var app = (function () {
    ...
    /* src/ProgressBar.svelte generated by Svelte v3.22.2 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-soupy0");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-soupy0");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src/Timer.svelte generated by Svelte v3.22.2 */
    ...
    /* src/HowTo.svelte generated by Svelte v3.22.2 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			nav.innerHTML = `<a class="navbar-brand">Handwashing App</a> 
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button> 
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup"><div class="navbar-nav"><a class="nav-item nav-link" href="https://master.d30wuvfk5j97tx.amplifyapp.com/">Covid-19 Global Dashboard <span class="sr-only">(current)</span></a> 
            <a class="nav-item nav-link" href="https://covid-flask.herokuapp.com/">Covid-19 Probability Detector</a> 
            <a class="nav-item nav-link" href="#">Pricing</a></div></div>`;

    			t9 = space();
    			br0 = element("br");
    			t10 = space();
    			h1 = element("h1");
    			h1.textContent = "Press the \"Start\" Button When You Are Ready";
    			t12 = space();
    			br1 = element("br");
    			t13 = space();
    			...
    			audio_1.innerHTML = `<source src="Tada-sound.wav">`;
    			attr(nav, "class", "navbar navbar-expand-lg navbar-dark bg-dark");
    			attr(h1, "class", "svelte-fknbcg");
    			attr(h3, "class", "svelte-fknbcg");
    		},
    		m(target, anchor) {
